...
import astronet.servicios.Servicios;
...
public class ClienteController implements Serializable {
	...
	public Servicios serviciosParam = new Servicios();
	...
	public String ipVerificar() {
		
		EquipoServicio equipo = new EquipoServicio();
		equipo = eqServOn.findByName(this.ip);
		System.out.println("Mijaaa"+equipo.getIp());
		System.out.println("Mijaaa"+equipo.getIp());
		equipo.setPing("on");
		System.out.println("IdCliPing: " + equipo.getId());
